<x-app-layout title="Tambah Jenis Cuti">
    <div class="mb-5">
    ...
    <div class="max-w-xl">
        <x-form-card title="Tambah Jenis Cuti">
            <form method="POST" action="{{ route('jenis-cuti.store') }}" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="kode" name="kode" value="{{ old('kode') }}" required maxlength="10"
                           ...
                           placeholder="CT">
                    <p class="text-xs text-gray-400 mt-1">Kode singkat unik, maks. 10 karakter (otomatis huruf besar).</p>
                    @error('kode')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="batas_hari" name="batas_hari" value="{{ old('batas_hari') }}"
                           min="1" max="365"
                           class="w-full border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-start gap-3 p-3 border border-gray-200 rounded-lg">
                        ...
                        <input type="checkbox" id="membutuhkan_lampiran" name="membutuhkan_lampiran" value="1"
                               {{ old('membutuhkan_lampiran') ? 'checked' : '' }}
                               class="mt-0.5 rounded border-gray-300 text-blue-900 focus:ring-blue-500">
                        <div>
